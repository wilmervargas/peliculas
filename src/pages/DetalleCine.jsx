    ...
    return (
        <div className="relative min-h-screen pb-12">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-8 sm:pt-16">
                <Link to="/" className="inline-flex items-center gap-2 text-gray-400 hover:text-white transition-colors mb-8 bg-gray-900/50 px-4 py-2 rounded-lg border border-gray-800 backdrop-blur-sm">
